...
const createStyles = (palette) =>
  StyleSheet.create({
    container: { flex: 1, backgroundColor: Platform.OS === 'android' ? '#E8E4ED' : 'transparent' },
    scrollView: { flex: 1 },
    scrollContent: { paddingHorizontal: Platform.OS === 'android' ? spacing.sm : spacing.lg },
    headerRow: { flexDirection: 'row', alignItems: Platform.OS === 'android' ? 'flex-start' : 'center', justifyContent: 'space-between', marginBottom: Platform.OS === 'android' ? spacing.sm : spacing.md },
    pageTitle: { ...typography.h1, fontSize: Platform.OS === 'android' ? 24 : 34, fontWeight: '700', textTransform: Platform.OS === 'android' ? 'uppercase' : 'none', letterSpacing: Platform.OS === 'android' ? 1.2 : 0 },
    pageSubtitle: { ...typography.bodySmall, marginTop: 2, fontSize: Platform.OS === 'android' ? 12 : typography.bodySmall.fontSize },
    iconButton: { width: Platform.OS === 'android' ? 32 : 38, height: Platform.OS === 'android' ? 32 : 38, borderRadius: Platform.OS === 'android' ? 2 : 19, borderWidth: Platform.OS === 'android' ? 2 : 1, alignItems: 'center', justifyContent: 'center' },
    headerAddWrap: { flexDirection: 'row', alignItems: Platform.OS === 'android' ? 'flex-start' : 'center', justifyContent: 'flex-end' },
    headerSettingsButton: {
      width: Platform.OS === 'android' ? 32 : 38,
      height: Platform.OS === 'android' ? 32 : 38,
      borderRadius: Platform.OS === 'android' ? 2 : 19,
      borderWidth: Platform.OS === 'android' ? 2 : 1,
      alignItems: 'center',
      justifyContent: 'center',
      marginRight: Platform.OS === 'android' ? spacing.xs : spacing.sm,
      ...(Platform.OS === 'android' ? {} : shadows.small),
    },
    headerAddButton: {
      width: Platform.OS === 'android' ? 34 : 42,
      height: Platform.OS === 'android' ? 34 : 42,
      borderRadius: Platform.OS === 'android' ? 2 : 21,
      alignItems: 'center',
      justifyContent: 'center',
      ...(Platform.OS === 'android' ? {} : shadows.small),
    },
    ...
    sectionCard: { borderRadius: Platform.OS === 'android' ? 2 : borderRadius.xl, borderWidth: Platform.OS === 'android' ? 2 : 1, padding: Platform.OS === 'android' ? spacing.sm : spacing.md, marginBottom: Platform.OS === 'android' ? spacing.sm : spacing.md },
    sectionTitle: { ...typography.body, fontWeight: '700', marginBottom: spacing.sm, textTransform: Platform.OS === 'android' ? 'uppercase' : 'none' },
    ...
    formInput: { borderWidth: Platform.OS === 'android' ? 2 : 1, borderRadius: Platform.OS === 'android' ? 2 : borderRadius.md, paddingVertical: spacing.sm, paddingHorizontal: spacing.md, ...typography.body, marginBottom: spacing.sm },
    ...
    segmentWrap: { flexDirection: 'row', borderRadius: Platform.OS === 'android' ? 2 : borderRadius.full, borderWidth: Platform.OS === 'android' ? 2 : 1, padding: Platform.OS === 'android' ? 1 : 3, marginBottom: spacing.sm },
    segment: { flex: 1, borderRadius: Platform.OS === 'android' ? 2 : borderRadius.full, alignItems: 'center', paddingVertical: Platform.OS === 'android' ? 6 : 9 },
